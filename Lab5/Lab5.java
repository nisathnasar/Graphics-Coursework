...
public class Lab5 extends GraphicsLab
{
    ...
    private Texture groundTextures, skyTexture, nightSkyTexture;
    ...
    protected void initScene() throws Exception
    {
        ...
        skyTexture = loadTexture("Lab5/textures/daySky.bmp");
        nightSkyTexture = loadTexture("Lab5/textures/nightSky.bmp");
    ...
    protected void renderScene()
    {
        ...
        GL11.glPushMatrix();
        {
            ...
            float sunMat[] = {0.5f, 0.5f, 0.5f, 1.0f};
            
            GL11.glMaterial(GL11.GL_FRONT, GL11.GL_EMISSION, FloatBuffer.wrap(sunMat));
