...
/**
 * This sample demonstrates the use of OpenGL calls to construct objects within
 * the 3D scene
 * 
 * <p>
 * Controls:
...
public class Lab3 extends GraphicsLab {
	/**
	 * display list id for the unit cube. Note that the initialised value given to a
	 * display list id attribute is the id you _want_ to use in your code - you must
	 * therefore pass a valid (positive) display list id to glNewList; an invalid
	...
	protected void initScene() {
		...
		GL11.glNewList(cubeList, GL11.GL_COMPILE);
		{
			...
			drawUnitCube(new Colour(153, 147, 129), Colour.RED, new Colour(158, 123, 16), new Colour(158, 123, 16), Colour.GREEN, Colour.GREEN);
			//GL11.glTranslatef(0f, 0.5f, 0f);
			//drawUnitRoof(new Colour(219, 170, 24), new Colour(219, 96, 24), new Colour(219, 96, 24), new Colour(219, 96, 24), Colour.GREEN);
		}
		GL11.glEndList();
	...
	protected void checkSceneInput() {// empty
	}
	...
	public void drawUnitRoof(Colour near, Colour far, Colour left, Colour right, Colour bottom) {
		Vertex v1 = new Vertex(0f, 1f, 0.5f);
		Vertex v2 = new Vertex(-0.5f, 0f, 0.5f);
		Vertex v3 = new Vertex(0.5f, 0f, 0.5f);
		Vertex v4 = new Vertex(0f, 1f, -0.5f);
