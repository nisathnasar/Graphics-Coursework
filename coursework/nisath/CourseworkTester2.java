 ...
 *  |	+--[T(0f, 0.1f, 1.2f)] Ball
 *  |
 *  +-- [T(-5, 0.07f, -26)] Railing left
 *  |	|
 *  |	+-- [T(10, 0, 0)] Railing right
 *  |
 ...
 *  |	
 *  +-- [T(0, 11, -49) S(1, 1.4f, 1)] TV
 *  |
 *  +-- [S(0.5f, 0.5f, 0.5f) T(4, 10.7f, 5) RY(180)] Man
 */
 ...
 * origin
 * <li>Press space bar to roll the ball or resume animation if paused, or continue after ball stopped rolling.
 ...
 *
 */
public class CourseworkTester2 extends GraphicsLab {
	...
	public static void main(String args[]) {
		new CourseworkTester2().run(WINDOWED, "Coursework Tester 2", 1f);
	}
...
//		System.out.println("4RowFall: " + isRowFall4);
	...
	private void renderPins() {
		GL11.glPushMatrix();
		{
			GL11.glTranslatef(0, 0, rowPosition1 + 12);
