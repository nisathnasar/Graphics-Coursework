...
public class Lab6 extends GraphicsLab {
	...
	private float currentSunY = lowestSunY;
	...
	protected void updateScene() {
		...
		// rising/ lowering sun
		if (risingSun && currentSunY < highestSunY) {
	...
	private void updateLighting() {
		// global ambient light level
		float globalAmbient[] = { 0.1f, 0.2f, 0.9f, 1.0f };
		// set the global ambient lighting
		GL11.glLightModel(GL11.GL_LIGHT_MODEL_AMBIENT, FloatBuffer.wrap(globalAmbient));
		// the first light for the scene is soft blue...
		float diffuse0[] = { 0.2f, 0.2f, 0.4f, 1.0f };
	...
	private void drawMoon() {
		GL11.glPushMatrix();
		{
			...
			float moonFrontSpecular[] = { 0.1f, 0.1f, 0.1f, 1.0f };
			// diffuse reflection of the front faces of the moon
			float moonFrontDiffuse[] = { 1f, 1f, 1f, 1.0f };
	...
	private void drawTree() {
		GL11.glPushMatrix();
		{
			...
			// how shiny are the front faces of the leafy head of the tree (specular
			// exponent)
			...
			new Sphere().draw(0.8f, 50, 50);
		}
		GL11.glPopMatrix();
	}

	private void drawHouseAndRoof() {
		GL11.glPushMatrix();
		{
